      ...
      <div ref={ref} className="wrap">
        ...
        <div className="grid lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          ...
          <motion.div variants={up(0)} initial="hidden" animate={v ? "show" : "hidden"}>
            <div className="bg-[#FDFBF7] rounded-3xl p-10 md:p-14 border border-[#C9A86A]/8 flex flex-col items-center text-center">

              {/* Product image */}
              <div className="relative w-44 h-44 md:w-56 md:h-56 rounded-2xl overflow-hidden shadow-[0_16px_60px_rgba(0,0,0,0.12)] mb-8 ring-1 ring-[#C9A86A]/10">
            ...
            <div className="space-y-6 mb-14">
              {benefits.map((b, i) => (
                <div key={i} className="flex items-start gap-4 group">
                  ...
                  <p className="font-body text-[14px] text-[#111111]/55 leading-[1.8] group-hover:text-[#111111]/70 transition-colors">{b}</p>
                </div>
              ))}
            </div>

            {/* Details strip */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-5 p-7 bg-[#FDFBF7] rounded-2xl border border-[#111111]/4">
              {[
                ["200g", "Net Weight"],
                ...
                <div key={lbl} className="text-center">
                  <p className="font-heading text-[18px] text-[#111111]/75">{val}</p>
